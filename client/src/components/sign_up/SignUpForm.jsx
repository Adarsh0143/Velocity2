            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-lg">
                    ...
                    <form
                        ...
                        className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 bg-gray-700"
                    >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    {...register("username")}
                                    type="text"
                                    className="w-full  border-gray-200 p-4 pe-12 text-lg shadow-sm  text-gray-900"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    {...register("password")}
                                    type="password"
                                    className="w-full border-gray-200 p-4 pe-12 text-xl shadow-sm  text-gray-900"
                        ...
                        <div className="flex justify-center mx-auto  text-white ">
                            <p className="text-lg">Already have an account? </p>
                                <Link to={"/login"}>
                                <p className="text-lg hover:text-blue-500/75 "> Login</p>
                            </Link>
                        </div>
                    </form>
                </div>
