        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="md:flex md:items-center md:gap-12">
              <Link to={"/"}>
              <span className="block text-white-600 text-4xl  hover:text-blue-500/75">
                Velocity
              </span>
              </Link>
            </div>
            ...
            <div className="hidden md:block">
              <nav aria-label="Global">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <Link to={"/"} 
                      className="text-white transition text-xl hover:text-blue-500/75"
                      href="#"
                    >
                      Home
                    </Link>
                  ...
                  <li>
                  {
                                ...
                                <>
                                    <li>
                                        <Link to='/orders' className="text-white transition text-xl hover:text-blue-500/75">Library</Link>
                                    </li>
                                </>
                            }
                  </li>
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                {isAuthenticated ? (
                  <button
                    className="rounded-md bg-gray-600 px-5 py-2.5 text-xl font-medium text-white shadow  hover:text-blue-500/75"
                    onClick={() => setLogout()}
                  >
                    Logout
                  </button>
                  ...
                  <Link to="/login">
                    <button className="rounded-md bg-gray-600 px-5 py-2.5 text-xl  font-medium text-white shadow hover:text-blue-500/75">
                      Login
                    </button>
                  </Link>
                )}
